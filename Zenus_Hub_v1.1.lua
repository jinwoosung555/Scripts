-- ZENUS HUB v1.1 — SELF-CONTAINED
-- Build: 2026-02-26 14:53:53
-- Build ID: 37ar2ba8570b
-- By: Naksh & CuttyFlam — #PREMIUMWALTERSANCHEZ
-- ALL-IN-ONE — NO LOADSTRING, NO EXTERNAL URLS
-- Generated by builder.py — DO NOT EDIT MANUALLY

local _BUILD_VERSION = "1.1"
local _BUILD_ID = "37ar2ba8570b"
local _BUILD_BRAND = "ZENUS HUB"
...
do  
    ...
    if not _bootClean then
        warn("[Zenus Hub] [!] Anti-hook bootstrap: hooks detected at load time!")
    end
...
_modules["security"] = function()
    ...
    --[[
        Zenus Security Module v1.1 — ANTI-HOOK / ANTI-TAMPER
        ...
        ZENUS HUB — #PREMIUMWALTERSANCHEZ
    ]]  
    ...
    function Security.startHeartbeat()
        task.spawn(function()
            ...
            while true do
                ...
                pcall(function()
                    if getgenv and getgenv().ZenusShuttingDown then return end
                end)
...
_modules["utils"] = function()
    ...
    Utils.ROOT_FOLDER = "Zenus"
    Utils.DATA_FOLDER = "Zenus/Data"
    Utils.IMAGES_FOLDER = "Zenus/Assets/Images"
    Utils.SOUNDS_FOLDER = "Zenus/Assets/Sounds"
    
    -- Constants
    Utils.API_BASE = "https://keyserver.nexusdevs.fun"
    Utils.STATS_FILE = "Zenus/Data/ZenusHub_Stats.nxs"
    Utils.CLIENT_VERSION = "6.6"
    Utils.AUTH_URL = Utils.API_BASE -- Debug endpoint only
    ...
    Utils.BANKAI_FILE = "Zenus/Assets/Sounds/bankai.mp3"
    Utils.LOGO_FILE = "Zenus/Assets/Images/ZenusLogo.png"
    ...
    function Utils.initFolders()
        pcall(function()
            ...
            print("[ZenusHub] [+] Workspace folders initialized")
        end)
    end
    ...
    -- CSM v2 File Format Constants
    local CSM_HEADER = "CSM"
    local CSM_VERSION = 2
    local CSM_SEPARATOR = "|"
    ...
    -- ============================================
    -- CSM v2 FILE FORMAT
    -- Format: CSM|VERSION|CHECKSUM|ENCRYPTED_DATA
    -- ============================================
    
    function Utils.encryptCSMv2(data)
        local encrypted = Utils.encrypt(data)
        local checksum = fnv1aHash(data)
        return CSM_HEADER ..
            CSM_SEPARATOR .. tostring(CSM_VERSION) .. CSM_SEPARATOR .. checksum .. CSM_SEPARATOR .. encrypted
    end
    
    function Utils.decryptCSMv2(content)
        if not content or content == "" then
            return nil, "Empty content"
        end
    
        -- Check if it's CSM v2 format
        if content:sub(1, 4) == CSM_HEADER .. CSM_SEPARATOR then
            local parts = {}
            for part in content:gmatch("([^" .. CSM_SEPARATOR .. "]+)") do
            ...
            return nil, "Invalid CSM v2 format"
        end
    ...
    function Utils.verifyCSMIntegrity(content)
        if not content or content == "" then
            return false, "Empty content"
        end
    
        if content:sub(1, 4) ~= CSM_HEADER .. CSM_SEPARATOR then
            return false, "Not CSM v2 format"
        end
    
        local _, err = Utils.decryptCSMv2(content)
    ...
    Utils.Zenus_LOGO = "https://nexusdevs.fun/assets/logos/nexus_dark.webp"
    Utils.Zenus_BANNER = "https://nexusdevs.fun/assets/banners/banner.webp"
    ...
    function Utils.sendWebhookEmbed(webhookUrl, data)
        ...
        local embed = {
            title = data.title or "ZenusHub",
            description = data.description or "",
            color = data.color or 10181046,
            fields = data.fields or {},
            author = {
                name = "Zenus",
                icon_url = Utils.Zenus_LOGO,
                url = "https://nexusdevs.fun"
            },
            thumbnail = { url = data.thumbnail or Utils.Zenus_LOGO },
            footer = {
                text = "ZenusHub v" .. Utils.CLIENT_VERSION .. " | By: Ryu & Cuakcer",
                icon_url = Utils.Zenus_LOGO
            },
            ...
            components = {
                ...
                container({
                    ...
                    textDisplay(
                        ...
                        "-# 👤 " .. lp.Name .. " • ZenusHub v" .. Utils.CLIENT_VERSION
                    ),
                }, 15158332), -- Red accent
            }
        })
    ...
    function Utils.notifyStart(webhookUrl, config)
        ...
        return Utils.sendWebhook(webhookUrl, {
            components = {
                container({
                    textDisplay("# ▶️ ZENUS HUB STARTED"),
                    separator(1, true),
                    section(
                    ...
                    separator(1, true),
                    textDisplay("-# ZenusHub v" .. Utils.CLIENT_VERSION .. " • Blox Fruits • By: Ryu & Cuakcer"),
            ...
            if isfile and isfile(Utils.STATS_FILE) then
                ...
                if decrypted then
                    ...
                    if err == "migrated_from_v1" then
                        ...
                        print("[ZenusHub] [+] Stats file migrated to ZenusHub v2 format")
                    end
                else
                    print("[ZenusHub] [!] Stats file corrupted: " .. (err or "unknown"))
                end
            end
        end)
    ...
    Utils.IMAGE_CACHE_FOLDER = "ZenusHub/Assets/Images"
    ...
    function Utils.notify(title, text, duration)
        ...
        local uiRef = nil
        pcall(function() uiRef = getgenv()._ZenusUI end)
    ...
    function Utils.downloadBankaiSound(customUrl)
        ...
        if isFile(soundFile) then
            print("[ZenusHub] [*] Sound already cached")
            return soundFile
        end
        ...
        if success and content and #content > 1000 then
            ...
            print("[ZenusHub] [+] Sound downloaded and cached")
            return soundFile
        end
    
        print("[ZenusHub] [!] Failed to download sound")
        return nil
    end
    ...
    function Utils.playBankaiSound(customUrl)
        ...
        print("[ZenusHub] [>] Playing startup sound")
        return true
    end
    ...
    Utils.DEBUG_FILE = "Zenus/debug.CSM"
    Utils._debugLog = {}
...
_modules["config"] = function()
    ...
    --[[
        ZenusHub Configuration Module v6.6
    ...
    -- Config file path
    Config.CONFIG_FILE = "Zenus/Data/config.json"
    ...
    function Config.init(utilsModule)
        ...
        print("[ZenusHub] [+] Config initialized")
        return finalConfig
    end
    
    -- ============================================
    -- CROSS-PLATFORM FILE SYSTEM HELPER
    -- (Zenus-based — no Utils dependency)
    -- ============================================
    ...
    function Config.loadFromFile()
        ...
        if not fs.fileExists(Config.CONFIG_FILE) then
            -- Try to migrate from old .csm file if it exists
            local oldFile = "Zenus/Data/ZenusHub_Config.CSM"
            if fs.fileExists(oldFile) then
                -- Old format can't be read (encryption funcs removed), treat as first run
                print("[ZenusHub] [!] Old .csm config found, migrating to JSON format")
            end
            return nil, true
        end
        ...
        if success and type(decoded) == "table" then
            ...
            print("[ZenusHub] [!] Config file corrupted, using defaults")
        end
    ...
    function Config.saveToFile()
        ...
        if not fs.folderExists("Zenus") then fs.makeFolder("Zenus") end
        if not fs.folderExists("Zenus/Data") then fs.makeFolder("Zenus/Data") end
...
_modules["ui"] = function()
    ...
    local IMAGE_FOLDER = "Zenus/Assets/Images"
    pcall(function()
        if makefolder then
            makefolder("Zenus")
            makefolder("Zenus/Assets")
            makefolder("Zenus/Assets/Images")
        end
    end)
    
    -- Image Loader with Caching (saves to Zenus/Assets/Images/ folder)
    ...
    local function createConfigPopup(screenGui)
        ...
        local titleText = isFirstRun and "⚡ Welcome to ZenusHub!" or "⚙ Configuration"
        ...
        testWebhookBtn.MouseButton1Click:Connect(function()
            ...
            if webhookUrl == "" or not webhookUrl:match("https://discord.com/api/webhooks/") then
                Utils.notify("ZenusHub", "[!] Please enter a valid Discord webhook URL")
                return
            end
            ...
            task.spawn(function()
                ...
                if success then
                    ...
                    Utils.notify("ZenusHub", "[+] Webhook test successful!")
                else
                    pulseElement(testWebhookBtn, Colors.Error, 0.3)
                    Utils.notify("ZenusHub", "[!] Webhook test failed!")
                end
            end)
        end)
        ...
        saveBtn.MouseButton1Click:Connect(function()
            ...
            Utils.notify("ZenusHub", "[+] Configuration saved!")
        ...
        debugBtn.MouseButton1Click:Connect(function()
            ...
            task.spawn(function()
                ...
                if ok then
                    ...
                    Utils.notify("ZenusHub", "[+] Debug file shared with admins!")
                else
                    debugBtn.Text = "\xE2\x9D\x8C Failed"
                    pulseElement(debugBtn, Colors.Error, 0.3)
                    Utils.notify("ZenusHub", "[!] Failed to share debug file")
                end
    ...
    function UI.createDiscordIcon(parent, position, size, zIndex)
        ...
        container.MouseButton1Click:Connect(function()
            ...
            if Utils then Utils.notify("ZenusHub", "[+] Discord invite copied!") end
    ...
    local function createDashboard(parent)
        ...
        local header = createText(headerContainer, "ZenusHub v6.5", {
            position = UDim2.new(0, 0, 0, 0),
        ...
        -- Zenus status label (key expiry system removed)
        local statusLabel = createText(dashboard, "ZENUS HUB • READY", {
            name = "StatusLabel",
        ...
        killGfxBtn.MouseButton1Click:Connect(function()
            ...
            if Utils then Utils.notify("ZenusHub", "Kill GFX is coming soon!") end
            task.delay(2, function()
    ...
    function UI.init(utilsModule, configModule, authModule)
        ...
        -- Cleanup existing
        pcall(function()
            if lp.PlayerGui:FindFirstChild("ZenusHubUI") then
                lp.PlayerGui.ZenusHubUI:Destroy()
            end
            if CoreGui:FindFirstChild("ZenusHubUI") then
                CoreGui.ZenusHubUI:Destroy()
            end
            if Lighting:FindFirstChild("ZenusHubBlur") then
                Lighting.ZenusHubBlur:Destroy()
            end
        end)
        
        -- Create ScreenGui
        local screenGui = Instance.new("ScreenGui")
        screenGui.Name = "ZenusHubUI"
        ...
        -- ═══ ZENUS HUB SPLASH / LOADING SCREEN ═══
        ...
        versionLabel.Text = "ZenusHub v6.5"
        ...
        local stages = {
            ...
            {text = "Starting Zenus Hub...", progress = 0.55},
        ...
        -- Create screens
        -- Key system removed: start directly on the dashboard.
        UI.KeyScreen = nil
        UI.Dashboard = createDashboard(rightPanel)
        UI.Dashboard.Visible = true
        ...
        -- Key authentication removed: dashboard is available immediately.
        if Config and (Config.isFirstRun() or not Config.isConfigured()) then
            task.delay(0.5, function()
                pcall(function() UI.openConfig() end)
            end)
        end
    ...
    function UI.setupCallbacks()
        ...
        if UI.Elements.serverHopBtn then
            UI.Elements.serverHopBtn.MouseButton1Click:Connect(function()
                if getgenv().ZenusHub and getgenv().ZenusHub.serverHop then
                    getgenv().ZenusHub.serverHop()
                end
            end)
        end
        ...
        if UI.Elements.stopBtn then
            UI.Elements.stopBtn.MouseButton1Click:Connect(function()
                ...
                if getgenv().ZenusHub then
                    getgenv().ZenusHub.Running = false
                end
    ...
    function UI.destroy()
        ...
        print("[ZenusHub] [*] UI connections cleaned up")
    ...
    function UI.killAllGraphics()
        pcall(function()
            -- Remove all ScreenGuis except ZenusHubUI
            for _, gui in ipairs(lp.PlayerGui:GetChildren()) do
                if gui:IsA("ScreenGui") and gui.Name ~= "ZenusHubUI" then
            ...
            pcall(function()
                for _, gui in ipairs(CoreGui:GetChildren()) do
                    if gui:IsA("ScreenGui") and gui.Name ~= "ZenusHubUI" and gui.Name ~= "RobloxGui" then
            ...
            pcall(function()
                for _, effect in ipairs(Lighting:GetChildren()) do
                    if effect:IsA("PostEffect") and effect.Name ~= "ZenusHubBlur" then
            ...
            if Utils then
                Utils.notify("ZenusHub", "[*] Graphics killed! Maximum FPS mode.")
    ...
    do
        ...
        local function processQueue()
            ...
            -- Strip the "[ZenusHub]" / "ZenusHub" prefix (the title is redundant in-island)
            text = text:gsub("^%[ZenusHub%]%s*", ""):gsub("^ZenusHub%s*", "")
...
_modules["main"] = function()
    ...
    --[[
        ZenusHub Main v6.5 — HYPER MODE (Forked from Zenus HyperLib v7.2)
    ...
    function Main.start()
        Main.Running = true
        print("[ZenusHub] [HYPER] Main.start() called")
        task.spawn(function()
            local ok, err = xpcall(function()
    
            print("[ZenusHub] [HYPER] task.spawn started")
            ...
            print("[ZenusHub] [HYPER] Stats synced")
            ...
            print("[ZenusHub] [HYPER] Kick detection setup")
            ...
            if not (lp.Character and lp.Character:FindFirstChild("HumanoidRootPart")) then
                print("[ZenusHub] [HYPER] Character not spawned — handling team selection")
                ...
                print("[ZenusHub] [HYPER] Character already exists — skipping team selection")
            end
    
            print("[ZenusHub] [HYPER] Character ready — initializing combat systems")
            ...
            print("[ZenusHub] [HYPER] All systems initialized — starting combat loops")
    
            -- ============================================
            -- CONTINUOUS M1 ATTACK LOOP — NEVER STOPS
            -- ============================================
            print("[ZenusHub] [HYPER] Starting M1 attack loop")
            task.spawn(function()
                while true do
                    task.wait(0.01)
                    pcall(function()
            ...
            -- ============================================
            print("[ZenusHub] [HYPER] Starting target cycle loop")
            task.spawn(function()
                task.wait(3)
            ...
            -- T-REX COMBAT LOOP
            -- ============================================
            print("[ZenusHub] [HYPER] Starting T-Rex combat loop")
            local Buso = { "Buso" }
            ...
            -- ============================================
            print("[ZenusHub] [HYPER] Starting PvP/utility loop — SCRIPT IS NOW FULLY ACTIVE")
            while wait(1) do
                pcall(function()
                    PvpEnable()
                    antimover()
            ...
            if not ok then
                warn("[ZenusHub] [HYPER] FATAL ERROR: " .. tostring(err))
            end
        end) -- End task.spawn
    end
    ...
    function Main.stop()
        ...
        print("[ZenusHub] [*] Script stopped - all connections cleaned up")
    end
...
--[[
    ...
    loadstring(readfile("COSMICScripts/loader.lua"))()
]]
...
local function loadModule(name)
    if _modules[name] then
        ...
        if ok then
            print("[ZENUS HUB] [+] Module loaded: " .. name)
            return result
        else
            local errMsg = "[ZENUS HUB] [!] Module error (" .. name .. "): " .. tostring(result)
            warn(errMsg)
            table.insert(_loadErrors, { module = name, error = tostring(result), time = os.time() })
            error(errMsg)
        end
    end
    local errMsg = "[ZENUS HUB] [!] Module not found: " .. name
    warn(errMsg)
...
print("[ZENUS HUB] Loading modules...")
...
print("[ZENUS HUB] Modules loaded!")

-- Initialize
Config.init()

print("[ZENUS HUB] Config: Fruit=" .. Config.get("Fruit") .. ", Region=" .. Config.get("Region") .. ", Faction=" .. Config.get("Faction"))

-- ============================================
-- INITIALIZE UI
-- ============================================

print("[ZENUS HUB] Initializing UI...")

-- Init UI directly; key system has been removed.
UI.init(Utils, Config, nil)

print("[ZENUS HUB] UI ready!")
...
task.spawn(function()
    -- Key authentication removed. Load main logic immediately.
    print("[ZENUS HUB] Loading character...")
    Main.init(Utils, Config, UI)
    
    -- Wait for configuration (UI) to be set by the user or via getgenv().Config
    while not Config.isConfigured() do
        task.wait(0.5)
    end
    print("[ZENUS HUB] Fully configured! Proceeding...")

    -- Wait for Character & Select Team
    local playerGui
    repeat
        task.wait()
    ...
    repeat
        ...
        if attempt > 10 then
            print("[ZENUS HUB] [!] Auto-team selection taking too long. Click it manually!")
        end
    ...
    print("[ZENUS HUB] Character loaded! Starting main logic...")
...
print("[ZENUS HUB] Ready! Press RightControl to toggle UI.")
